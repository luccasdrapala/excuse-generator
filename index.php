      ...
      <div class="conteudo mt-4 mb-4">
        ...
        <form method="POST" action="#">
          <div class="row">
            ...
            <div class="col-md-3">
              <select class="form-select form-select-lg fs-5 mt-4 mb-4">
            ...
            <div class="col-md-7 d-grid gap-2"> 
              <button type="submit" class="btn btn-warning fs-5 mt-4 mb-4 fw-bold">Generate the Excuse</button>
            </div>
          </div>

          <div class="row">
            <div class="col-md-12">
              <textarea class="form-control mt-3 fs-5" rows= "3" placeholder="Your excuses should to appear here..." disabled></textarea>
            </div>
          </div>
        </form>
      </div>
